...
const Navbar  = () =>{
  ...
  const handleLogout = () => {
    ...
    return(
<>
<nav className="navbar bg-body-tertiary d-flex sticky-top">
  <div className="container-fluid">
  <div style={{ width: "3%", height: "4%", fill: "currentcolor" }}>
  <a href="/Allitems"><svg
    height={2}
    viewBox="0 0 24 24"
    width={3}
...
<yt-icon id="logo-icon" className="style-scope ytd-logo">
  ...
  <yt-icon-shape className="style-scope yt-icon">
    <icon-shape className="yt-spec-icon-shape">
      <div style={{ width: "40%", height: "30%", fill: "currentcolor",display:"flex" }}>
        <svg
...
<button className="btn border border-secondary rounded-end-pill" type="submit"><svg
  xmlns="http://www.w3.org/2000/svg"
  width={16}
  height={16}
  fill="currentColor"
...
{user._id && <a href="#" className="btn1 rounded-pill  btn-outline-dark btn-sm"  role="button" aria-disabled="true">
<div className="dropdown btn-group dropstart">
 <button
   className="btn btn-primary dropdown-toggle w-10 "
   type="button"
