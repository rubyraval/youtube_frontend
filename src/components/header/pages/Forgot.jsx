...
<span className="mx-auto p-2">Find your email</span>
</h2>
<span className="mx-auto p-2">Enter your phone number and recovery email</span>
...
<input type="submit"  name="sign-in" value="Next" className="bg-primery"></input>
</div>
